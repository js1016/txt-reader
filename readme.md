...
* [Methods](#user-content-methods)
    ...
    * [loadFile(file[ ,iteratorConfig])](#user-content-loadfile-file-iteratorconfig-)
    * [getLines(start, count)](#user-content-getlines-start-count-)
    * [iterateLines(iteratorConfig[, start, count])](#user-content-iteratelines-iteratorconfig-start-count-)
